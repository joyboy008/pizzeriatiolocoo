            ...
            <form>
              <div className="form first">
                ...
                <div className="details products">
                  <div>
                    <main className="table__sale_details" id="customers_table">
                      ...
                      <section className="table__body">
                        <table>
                          <thead className="table__head">
                            <tr>
                              <th className="th_products">Cantidad</th>
                              <th className="th_products">Nombre</th>
                              <th className="th_products">Precio</th>
                            </tr>
                          </thead>
                          <tbody>
                            {data.products.map((product, index) => (
                              <tr key={index}>
                                <td className="td_products">
                                  {product.quantity}
                                </td>
                                <td className="td_products">
                                  {product.product_name}
                                </td>
                                <td className="td_products">{product.price}</td>
                              </tr>
                            ))}
                          </tbody>
                        </table>
